...
<div id="main">
  ...
  <h1 style="color:#526E48; font-family:Arial, Helvetica, sans-serif; text-align: center; font-weight: bold;"class="text-center">Approved Books</h1>
...
if (isset($_SESSION['studentid'])) {
    ...
    $query = "
        SELECT 
            ...
            ib.approve, ib.issue, ib.return, ib.expected_return, ib.fine
        FROM issue_book ib
        JOIN student s ON s.studentid = ib.studentid
        JOIN books b ON b.bid = ib.bid
        WHERE ib.studentid = '$_SESSION[studentid]' AND ib.approve = 'approve'
    ";
} else {
