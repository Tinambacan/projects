...
<body style="background-color: #f4f4f4;">
    <div class="dashboard-container">
        <?php 
        // Fetch student data
        $q = mysqli_query($db, "SELECT firstname, lastname, studentid, email FROM student WHERE studentid='$_SESSION[studentid]';");
        ...
        <div class="content">  
            <h2> Welcome, <b> <?php echo $row['studentid'] ?>! </b>
            </h2> 
            ...
            <div class="details">
                ...
                <button class="btn btn-default" style="float: center; width: 70px; background-color:#9EDF9C;" name="submit1" data-toggle="modal" data-target="#editModal">Edit</button>
                <button class="btn btn-default" style="float: center; width: auto; background-color:#9EDF9C;" name="submit2" data-toggle="modal" data-target="#passwordModal">Change Password</button>
            </div>
...
<script>
    ...
    const data = {
        ...
        studentid: '<?php echo $row['studentid']; ?>',
...
document.querySelector('.btn-primary').addEventListener('click', function () {
    ...
    // Send AJAX request
    $.ajax({
        url: 'update_student.php', // PHP backend script
        type: 'POST',
        data: updatedData,
