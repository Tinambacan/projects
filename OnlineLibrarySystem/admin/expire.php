...
<nav class="navbar navbar-inverse">
  ...
  <a href="return.php">Returned Books Request</a>
...
<div id="main">
  ...
  <h1 style="color:#526E48; font-family:Arial, Helvetica, sans-serif; text-align: center; font-weight: bold;"class="text-center">Expired Book Request</h1>
...
if (isset($_SESSION['employeeid'])) {
    ...
    $query = "
        ...
        WHERE ib.approve = 'expired' OR ib.approve = 'paid'
...
if (mysqli_num_rows($res) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        echo "<td>
                <button class='btn btn-success' data-toggle='modal' data-target='#paidModal' data-issue-id='" . $row['issue_id'] . "'>
                    Paid
                </button>
              </td>";
        echo "</tr>";
    ...
    echo "<h1 style='text-align:center; font-weight:bold;'>No Expired Books Request Found</h1>";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="paidModalLabel">Confirm Payment</h4>
            </div>
            <div class="modal-body">
                Are you sure you want to mark this request as paid?
            </div>
            <div class="modal-footer">
                <form method="post" action="paid_due.php">
                    <input type="hidden" name="issue_id" id="paidID">
                    <button type="submit" name="paid" class="btn btn-warning">Yes</button>
...
<script>
    ...
    $('#paidModal').on('show.bs.modal', function (event) {
        ...
        $('#paidID').val(issueId); // Update the hidden input value in the modal
    });
function openNav() {
