...
<nav class="navbar navbar-inverse">
      ...
      <div class="student-registration-container">
        <div class="student-registration-content">
            ...
            <form name="registration" action="" method="post">
                ...
                <input type="number" name="employeeid" placeholder="Employee ID" required><br>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $checkQuery = "SELECT * FROM ADMIN WHERE employeeid = '$employeeid'";
            ...
            if (mysqli_num_rows($checkResult) > 0) {
                ...
                $insertQuery = "INSERT INTO ADMIN (firstname, lastname, employeeid, email, password) 
                                VALUES ('$firstname', '$lastname', '$employeeid', '$email', '$hashedPassword')";
