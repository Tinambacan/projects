...
<body id="board" class=" bg-purple-100 overflow-hidden">
        ...
        <div class="p-3  min-h-screen">
            <div
                ...
                <div class="flex justify-center items-center flex-col">
                    ...
                    <h3 class="text-indigo-900 font-bold mb-5 text-center">If you forgot your password or <br> having a
                        trouble logging in, we can <br> email you a password reset link.</h3>
                </div>

                <div class="p-5">
                    <form action="/change-new-pass" method="POST">
                        @csrf
                        ...
                        <div class="flex mt-8 justify-center drop-shadow-md">
                            <div class="flex flex-wrap text-center w-56">
                                <button type="submit" id="myLogin"
                                    class="btn text-indigo-900 btn-success bg-white p-2 border rounded-full hover:bg-orange-200 w-full lg:w-56 font-bold">Reset
                                    Password</button>
    ...
    <script type="module">
        ...
        if (email) {
            ...
            displayStudentNum.textContent = email;
        }
