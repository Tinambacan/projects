        ...
        <div class="p-3  min-h-screen">
            <div
                ...
                <div id="bcklogin"
                    ...
                    <a class="hover:underline"href="/student-login">
                        Back to Login
                    </a>
                </div>

                <div class="px-5 animate-fade-in-up1">
                    <form method="POST" action="/sent-email">
                        @csrf
                        <h1 class="mt-10 mb-5 text-3xl font-semibold text-center text-indigo-900">Student Activation
                        </h1>
                        <div class="my-2">
