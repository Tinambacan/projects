...
<body id="board" class=" bg-purple-100 overflow-hidden">
    ...
    @if (session('status') === 'warning')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                successModalLogin("{{ session('warning') }}");
            });
        </script>
    @endif
        ...
        <div class="p-3  min-h-screen">
            <div
                ...
                <div class="mb-5 mt-5 drop-shadow-md flex justify-between items-center">
                    ...
                    <div id="bcklogin" class="flex gap-2 text-indigo-900 rounded-xl p-2 text-center font-bold hover:text-violet-500">
                ...
                <div class="p-5">
                    <form action="/sign-in-profs" method="POST">
                        @csrf
                        <div class="drop-shadow-md">
                            <label class="block  font-bold text-indigo-900">Email or Username </label>
    ...
    <script type="module">
        ...
        const sign = document.getElementById("bcklogin");
