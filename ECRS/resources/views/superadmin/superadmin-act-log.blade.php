...
@section('content')
    ...
    <body>
        <div class="flex w-full">
            <div class="flex flex-col w-full transition-all duration-300 mt-12 animate-fadeIn">
                <x-titleText>
                    Activity Log
                </x-titleText>
                    ...
                    <div class="flex flex-col w-full">
                        <div class="rounded-lg my-3">
                            ...
                            <div class="bg-white border dark:bg-[#161616] border-gray-300 dark:border-[#404040] dark:text-white text-black p-3 rounded-md animate-fadeIn shadow-lg">
                                <table id="auditTableSuperAdmin" class="w-full display text-center justify-center">
                                    <thead>
                                        <tr>
