                ...
                <table class="container" width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td class="content" style="background-color: #f9f9f9; padding: 20px; border-radius: 10px;">
                            <p>{{ ucwords($professorSalutation) }} {{ ucwords($professorFname) }}
                                {{ ucwords($professorLname) }} has submitted class record report in
                                {{ ucwords($courseTitle) }}</p>
                            <p>To view or download the report click the button below</p>
