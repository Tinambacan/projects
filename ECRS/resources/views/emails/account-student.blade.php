                ...
                <table class="container" width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td class="header" style="text-align: center; padding-bottom: 20px;">
                            <img src="{{ URL('images/new-logo.png') }}" style="width: auto; height: 10vh;" alt="Logo">
                            <h2 style="font-size: 22px; font-weight: bold; color: #333333; margin: 0;">
                                Good day, {{ ucwords($fname) }} {{ ucwords($lname) }}!
                            </h2>
                        </td>
                    </tr>
                    <!-- Content -->
                    <tr>
                        <td class="content" style="background-color: #f9f9f9; padding: 20px; border-radius: 10px;">
                            <p style="font-size: 16px; color: #555555; margin: 10px 0;">
                                This is your student number <strong>{{ $studentno }}</strong>
                            </p>
                            <p style="font-size: 16px; color: #555555; margin: 10px 0;">
                                This is your temporary password <strong>{{ $plainPassword }}</strong>
                            </p>
                            <p style="font-size: 16px; color: #555555; margin: 10px 0; font-weight: bold;">
                                Please change your password immediately for your account security.
                            </p>
                            <p style="font-size: 16px; color: #555555; margin: 10px 0;">
