...
@section('loadscontent')
    ...
    <div style="" class="relative group flex justify-end cursor-pointer mb-3">
        @if ($adminBranch == 1)
            <div id="sendJson" class="flex justify-end dark:text-[#CCAA2C] text-red-900 text-xl gap-1 hover:bg-gray-200 dark:hover:bg-[#161616] p-[5px] rounded-md ">
                <i class="fa-solid fa-paper-plane"></i>
                <p class="text-sm">Send Faculty loadsss</p>
            </div>
