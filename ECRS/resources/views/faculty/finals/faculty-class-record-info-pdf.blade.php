...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="text-content">
                ...
                <h3>
                    {{ $registration->branch == 1 ? 'Taguig' : ($registration->branch == 2 ? 'Sta. Mesa' : 'Unknown') }} Branch
                </h3>
    ...
    <div id="textboxes">
        <p class="alignleft">{{ $registration->role == 1 ? 'Professor' : 'Unknown Role' }} 
            ...
            @if($registration->Mname) {{ ucfirst($registration->Mname) }}. @endif 
            {{ ucfirst($registration->Lname) }}</p>
    ...
    <div id="textbox">
        <p class="alignleft">
            Program: {{ $programCode }}: 
                @if($yearLevel == 1) 1-1 
                @elseif($yearLevel == 2) 2-1 
                @elseif($yearLevel == 3) 3-1 
                @elseif($yearLevel == 4) 4-1 
                @else Unknown Year Level 
                @endif    
        <p>
        <p class="alignright"> Semester:
                @if($semester == 1) 1st Semester 
                @elseif($semester == 2) 2nd Semester 
                @elseif($semester == 3) Summer Semester 
    ...
    <h3 class="title-grade">Finals Grade</h3>
