...
<head>
    ...
    <title>Finals | {{ ucwords($assessmentType) }}</title>
</head>
                        ...
                        <tbody>
                            @foreach ($assessments as $assessment)
                                <tr>
                                    ...
                                    <td class="text-center text-2xl flex gap-2 justify-center items-center">
                                        ...
                                        <i 
                                            class="fa-solid fa-pen-to-square text-green-500 edit-assessment"
            ...
            <div class="bg-white rounded-lg shadow-xl transform transition-all w-full max-w-screen-sm px-10">
                <div class="flex gap-10 mt-5">
                    <div class="flex flex-col">
                        <form id="add-assessment-form" action="{{ route('assessment.store-finals') }}">
                            @csrf
                            ...
                            <div class="flex gap-5">
                                ...
                                <div class="my-2 flex flex-col gap-2">
                                    ...
                                    <input type="date" name="assessmentDate"
                                        id="{{ strtolower(str_replace(' ', '-', $assessmentType)) }}-date"
        ...
        <x-modal title="Edit {{ ucwords($assessmentType) }}"
         ...
         closeBtnId="{{ 'close-btn-edit-' . strtolower(str_replace(' ', '-', $assessmentType)) }}">
            <div class="bg-white rounded-lg shadow-xl transform transition-all w-full max-w-screen-sm px-10">
                <div class="flex gap-10 mt-5">
                    <div class="flex flex-col">
                        <form id="edit-assessment-form" action="{{ route('assessment.update-finals') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="classRecordID" value="{{ $classRecords->classRecordID }}" />
