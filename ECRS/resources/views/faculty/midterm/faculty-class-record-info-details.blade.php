            ...
            <div class="flex flex-col w-full shadow-xl  rounded-lg px-4">
                ...
                <div class="relative z-10 h-full">
                    <div id="alert-success"
                        class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-sm bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded hidden"
                        role="alert">
