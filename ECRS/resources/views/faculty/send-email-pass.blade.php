            ...
            <div class="dark:text-white w-full">
                <div class="flex flex-col justify-center items-center animate-fadeIn">
                    ...
                    <form id="password-change-form" method="POST" class="md:w-[30rem] w-full">
                        @csrf
                        <div
                            class="bg-white border dark:bg-[#161616] border-gray-300 dark:border-[#404040] dark:text-white text-black  rounded-md animate-fadeIn shadow-lg p-5 my-5">
                    ...
                    <div class="text-center">
                        <span class="text-gray-800 dark:text-white">I remember my password,</span> <a
                            href="{{ route('faculty.login') }}" class="text-blue-600 underline">Login</a>
                    </div>
                </div>
            </div>
        </main>
...
<x-loader modalLoaderId="send-email-loader-fa" />
